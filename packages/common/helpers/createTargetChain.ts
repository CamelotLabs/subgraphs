...
const factoryV2 = ethers.getAddress(config?.contracts.factoryV2)
const wrappedNativeV2 = ethers.getAddress(config?.assets.native.address)
const wrappedNativeUSDCPoolV2 = ethers.getAddress(config?.assets.nativePairV2)
const whitelistTokensV2 = subgraphConfig?.whitelistTokensV2
const stableCoin = ethers.getAddress(config?.assets.stable)
...
const factoryV3 = ethers.getAddress(config?.contracts.factoryV3)
const nftPositionManagerV3 = ethers.getAddress(config?.contracts.nftPositionManagerV3)
const wrappedNativeV3 = ethers.getAddress(config?.assets.native.address)
const wrappedNativeUSDCPoolV3 = ethers.getAddress(config?.assets.nativePairV3)
...
const campaignFactory = ethers.getAddress(config?.contracts.campaignFactory)
const distributor = ethers.getAddress(config?.contracts.distributor)
